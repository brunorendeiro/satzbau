...
export const alphabet: LetterEntry[] = [
  ...
  { id: 'e', letter: 'E', name: 'eh', example: 'Elefant', examplePt: 'elefante', exampleEn: 'elephant', soundPt: 'Como o "ê" fechado de "mesa".', soundEn: 'Like the "ay" in "may" or "stay", but pure — no "y" glide at the end.', tricky: false },
  ...
  { id: 'i', letter: 'I', name: 'ih', example: 'Igel', examplePt: 'ouriço', exampleEn: 'hedgehog', soundPt: 'Como o "i" fechado de "vi".', soundEn: 'Like the "ee" in "see" — held clean and long, not clipped short.', tricky: false },
  ...
  { id: 'ouml', letter: 'Ö', name: 'ö', example: 'Öl', examplePt: 'óleo', exampleEn: 'oil', soundPt: 'Sem equivalente em português — diz um "é" aberto arredondando os lábios, como para dizer "ô".', soundEn: 'No English equivalent — closest is the vowel in British "bird" or "her" (drop the r), or say a short "e" while rounding your lips as if about to whistle.', tricky: true },
...
export const combos: LetterEntry[] = [
  ...
  { id: 'kn', letter: 'kn', name: 'kn', example: 'Knoblauch', examplePt: 'alho', exampleEn: 'garlic', soundPt: 'As duas letras ouvem-se claramente — ao contrário do inglês, aqui o "k" nunca é mudo.', soundEn: 'Both letters are clearly pronounced — unlike English "knife", the "k" is never silent here.', tricky: true },
  { id: 'ps', letter: 'ps', name: 'ps', example: 'Psychiater', examplePt: 'psiquiatra', exampleEn: 'psychiatrist', soundPt: 'As duas letras ouvem-se claramente — ao contrário do inglês, aqui o "p" nunca é mudo.', soundEn: 'Both letters are clearly pronounced — unlike English "psychology", the "p" is never silent here.', tricky: true },
  { id: 'pf', letter: 'pf', name: 'pf', example: 'Pfeffer', examplePt: 'pimenta', exampleEn: 'pepper', soundPt: 'As duas letras ouvem-se claramente, uma a seguir à outra — um som que o português e o inglês não têm.', soundEn: 'Both letters are clearly pronounced, one right after the other — a sound English doesn\'t have.', tricky: true },
]
